    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl max-w-4xl w-full mx-4 max-h-[90vh] overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-gray-50 to-white border-b border-gray-100 p-8 rounded-t-2xl">
                    <div className="text-center">
                        <h2 className="text-4xl font-light text-[#272343] mb-2 tracking-wide">Velour</h2>
                        <p className="text-lg text-gray-500 font-light">Crafting Comfort Since 1985</p>
                    </div>
                </div>

                {/* Content Section - Custom Scrollbar */}
                <div className="h-[calc(90vh-140px)] overflow-y-auto scrollbar-thin scrollbar-track-transparent scrollbar-thumb-gray-200 hover:scrollbar-thumb-gray-300">
                    <div className="p-8">
                        {/* About Section with Hero Image */}
                        <div className="mb-8">
                            <h3 className="text-2xl font-light text-[#272343] mb-6 flex items-center gap-2">
                        ...
                        {/* Gallery Section */}
                        <div className="mb-8">
                            <h3 className="text-xl font-light text-[#272343] mb-6 text-center">Our Latest Collection</h3>
                        ...
                        <div className="bg-gray-50 p-6 rounded-xl mb-8">
                            <h3 className="text-xl font-light text-[#272343] mb-4">Our Promise to You</h3>
